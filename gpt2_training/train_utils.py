...
class InputFeatures(object):
    def __init__(self, conv_id, input_ids, position_ids, token_type_ids,
                 lm_labels, context_len, response_len, meta=None):
...
class InputFeatures_train(object):
    def __init__(self, conv_id, input_ids, position_ids, token_type_ids,
                 lm_labels, weights, input_len=None, meta=None):
        self.conv_id = conv_id
...
class ExampleWithMeta(object):
    def __init__(self, conv_id, context, response, meta):
        self.conv_id = conv_id
        self.context = context
        self.response = response
        self.meta = meta
    ...
    def __repr__(self):
        return 'conv_id = {}\ncontext = {}\nresponse = {}\nmeta = {}'.format(
            self.conv_id, self.context, self.response, self.meta)
